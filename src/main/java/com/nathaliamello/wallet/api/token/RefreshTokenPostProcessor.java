...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
    ...
    @Autowired
    public RefreshTokenPostProcessor(WalletApiProperty walletApiProperty) {
    ...
    public boolean supports(MethodParameter returnType, Class<? extends HttpMessageConverter<?>> converterType) {
        ...
        if (null == returnType.getMethod()) {
            ...
            method = returnType.getMethod();
        }
        if (null != method && null != method.getName()) {
            return method.getName().equals("postAccessToken");
        }
        return false;
    }
    ...
    private void adicionarRefreshTokenNoCookie(String refreshToken, HttpServletRequest req, HttpServletResponse resp) {
        ...
        refreshTokenCookie.setSecure(walletApiProperty.getSeguranca().isEnableHttps());
